    ...
    <div className='flex flex-row justify-center'>
      ...
      <div className='m-10 flex flex-col space-y-4 max-w-[1100px] w-full'>
        ...
        <div className='flex flex-col text-start'>
          ...
          <p className='text-slate-500'>Welcome to HealthWay, today is Sunday. Use the dashboard below to see your personalized recipes, what pills you need to take, and the inventory of food that you have.</p>
        </div>
